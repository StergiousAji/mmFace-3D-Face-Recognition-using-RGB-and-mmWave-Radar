...
\begin{itemize}
    ...
    \item We present \texttt{mmFace}, a hybrid face recognition model that harnesses both modalities yielding a robust system capable of handling face concealment and nullifying 2D spoofing attempts. The model exhibits strong generalisation capabilities to unseen faces and discerns between live and fake faces effectively.
...
\begin{figure*}[!t] 
    ...
    \end{subfigure}
    \vspace{0.3cm}
    \caption{2D t-SNE projections of the final layer features of all test samples. Features are extracted from the $\mathtt{fc\_hybrid1}$ layer from each of the top three ranking models.}
    \vspace{-0.4cm}
\end{figure*}
