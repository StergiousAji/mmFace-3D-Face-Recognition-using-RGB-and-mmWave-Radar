...
\texttt{mmFace} contains around 18 million parameters and takes $x$ milliseconds to process a single (\texttt{ARD}, InsightFace RGB embedding) input.
%TODO: SINGLE INPUT PROCESSING TIME
