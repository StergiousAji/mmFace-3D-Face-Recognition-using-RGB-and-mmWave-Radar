...
% TODO: PRE-PROCESSING & DATA AUGMENTATIONS
...
\begin{figure}[h!]
    ...
    \caption{OvR ROC curves plotted for each of the eight reference embeddings using the Multi-Head Attention feature fusion. The respective AUC metrics are shown as well as the chance level and macro-averaged ROC curve.}
