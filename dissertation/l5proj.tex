...
\begin{enumerate}
    ...
    \begin{align*}
        ...
        \mathtt{pairwise\_dot\_average}&(\bm{\vec{x}}, \bm{\vec{y}}) = \left[\frac{1}{n} \sum_{j=1}^n \bm{Z}_{j,i} \ \middle| \ \forall i \in \{1, \ldots, n\}\right]
    \end{align*}
    ...
    \begin{align*}
        ...
        \begin{bmatrix}
            \bm{\vec{x}} \\
            \bm{\vec{y}}
        \end{bmatrix} \ & \bm{Q}_i = \bm{W}_{Q_i}\bm{X}, \\ 
        \bm{K}_i = \bm{W}_{K_i}&\bm{X} \ \mathit{and} \ \bm{V}_i = \bm{W}_{V_i}\bm{X}
    \end{align*}
\end{enumerate}
