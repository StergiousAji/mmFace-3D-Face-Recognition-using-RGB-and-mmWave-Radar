...
\section{Evaluation}
We evaluate our model by examining its discriminative ability at representing unseen faces. Various metrics such as the prediction accuracies, precision and recall are used to compare the different fusion strategies against each other as well showing
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccc}
        ...
        Pairwise Dot Mean & 88.83\% & 0.8464 & 80.81\% & 0.7699 \\
        ...
        \bottomrule
    \end{tabular}
    \caption{Subject and liveness accuracies and micro-averaged F1 measures for the seven feature fusion strategies along with the individual modalities.}
    \label{tab:results}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcc}
        ...
        Pairwise Dot Mean & 0.9204                      & 0.2155                 \\
